...
setup() {
    ...
    exprs_url="http://staff.washington.edu/hpliner/data/cao_l2_expression.rds"
    exprs_rds="${data_dir}/exprs.rds"
    obs_url="http://staff.washington.edu/hpliner/data/cao_l2_colData.rds"
    obs_rds="${data_dir}/obs.rds"
    var_url="http://staff.washington.edu/hpliner/data/cao_l2_rowData.rds"
